                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('mitra.gambar')}}">Lihat Gambar</a></li>
        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{route('mitra.gambar.update', $gambar->id_gambar_des)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-select select2" name="id_destinasi" id="id_destinasi">
                            ...
                            <a href="{{ route('mitra.gambar') }}" class="btn btn-secondary mr-3 float-right">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
