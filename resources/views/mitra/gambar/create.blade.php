        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('mitra.gambar.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ route('mitra.gambar.create') }}" class="btn btn-secondary mr-3 float-right" type="reset">Atur Ulang</a>
                        </form>
                    </div>
                </div>
            </div>
