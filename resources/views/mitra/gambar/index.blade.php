        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{route('mitra.gambar.create')}}" class="btn btn-sm btn-primary">Tambah Gambar Baru</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-flush" id="myTable">
                        ...
                        <tr>
                            ...
                            <td class="table-actions">
                                <a href="{{route('mitra.gambar.edit', $items->id_gambar_des)}}" class="table-action" data-toggle="tooltip" data-original-title="Edit product">
                                    <button type="button" class="btn btn-success"><i class="fas fa-user-edit"></i></button>
                                </a>
                                <a href="{{route('mitra.gambar.destroy', $items->id_gambar_des)}}" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Delete product" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">
