                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('mitra.des')}}">Lihat Destinasi</a></li>
        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{route('mitra.des.update', $destinasi->id_destinasi)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input class="form-control" type="text" name="id" readonly value="{{ Auth::user()->name }}">
                                    @endif
                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary float-right">Simpan</button>
                            <a href="{{ route('mitra.des') }}" class="btn btn-secondary mr-3 float-right">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
