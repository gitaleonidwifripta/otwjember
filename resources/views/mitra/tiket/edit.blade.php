        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{route('mitra.tiket.update', $tiket->id_tiket)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ route('mitra.tiket') }}" class="btn btn-secondary mr-3 float-right">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
