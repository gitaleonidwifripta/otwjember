        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.kate.update', $kategori->id_kategori)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="kategori" value="{{ $kategori->kategori }}">
                                    <small>Contoh : Wisata Religi, Wisata Pantai, dll.</small>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary float-right">Simpan</button>
                            <a href="{{ route('admin.kate') }}" class="btn btn-secondary mr-3 float-right">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
