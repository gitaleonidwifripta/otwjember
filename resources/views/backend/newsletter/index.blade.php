        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 d-inline-block mb-0">Newsletter</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Lihat Newsletter</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    @endif
                    <h3 class="mb-0">Daftar Newsletter</h3>
                    <p class="text-sm mb-0">
                        Menampilkan seluruh newsletter online tiket wisata jember
                    </p>
                </div>
