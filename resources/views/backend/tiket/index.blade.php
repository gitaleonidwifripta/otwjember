        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{route('admin.tiket.create')}}" class="btn btn-sm btn-primary">Tambah Tiket Baru</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-flush" id="myTable">
                        ...
                        <tr>
                            ...
                            <td class="table-actions">
                                <a href="{{route('admin.tiket.edit', $items->id_tiket)}}" class="table-action" data-toggle="tooltip" data-original-title="Edit product">
                                    <button type="button" class="btn btn-success"><i class="fas fa-user-edit"></i></button>
                                </a>
                                <a href="{{route('admin.tiket.destroy', $items->id_tiket)}}" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Delete product" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">
