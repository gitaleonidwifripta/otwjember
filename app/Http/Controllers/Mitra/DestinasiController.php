...
class DestinasiController extends Controller
{
    public function index()
    {
        ...
        return view('mitra/destinasi.index', compact('destinasi'));
    }
    ...
    public function create()
    {
        ...
        $user = User::all();
        return view('mitra/destinasi.create', compact('id_destinasi', 'destinasi', 'kategori', 'user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mitra.des')->with('success', 'Destinasi Wisata Berhasil Ditambahkan!');
    }
    ...
    public function edit($id_destinasi)
    {
        ...
        $kategori = kategori::all();
        $user = User::all();
        return view('mitra/destinasi.edit', compact('destinasi', 'kategori', 'user'));
    }
    ...
    public function update(Request $request, $id_destinasi)
    {
        ...
        return redirect()->route('mitra.des')->with('update', 'Destinasi Wisata Berhasil Diupdate!');
    }
    ...
    public function destroy($id_destinasi)
    {
        ...
        return redirect()->route('mitra.des')->with('error', 'Destinasi Wisata Berhasil Dihapus!');
    }
}
