...
class TiketController extends Controller
{
    public function index()
    {
        ...
        return view('mitra/tiket.index', compact('tiket'));
    }
    ...
    public function create()
    {
        ...
        return view('mitra/tiket.create', compact('id_tiket', 'tiket', 'destinasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mitra.tiket')->with('success', 'Tiket Wisata Berhasil Ditambahkan!');
    }
    ...
    public function edit($id_tiket)
    {
        ...
        $destinasi = destinasi::all();
        return view('mitra/tiket.edit', compact('tiket', 'destinasi'));
    }
    ...
    public function update(Request $request, $id_tiket)
    {
        ...
        return redirect()->route('mitra.tiket')->with('update', 'Tiket Wisata Berhasil Diupdate!');
    }
    ...
    public function destroy($id_tiket)
    {
        ...
        return redirect()->route('mitra.tiket')->with('error', 'Tiket Wisata Berhasil Dihapus!');
    }
}
