...
class GambarController extends Controller
{
    public function index()
    {
        ...
        return view('backend/gambar.index', compact('gambar'));
    }
    ...
    public function create()
    {
        ...
        return view('backend/gambar.create', compact('id_gambar_des', 'gambar', 'destinasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.gambar')->with('success', 'File Berhasil Ditambahkan!');
    }
    ...
    public function edit($id_gambar_des)
    {
        ...
        $destinasi = destinasi::all();
        return view('backend/gambar.edit', compact('gambar', 'destinasi'));
    }
    ...
    public function update(Request $request, $id_gambar_des)
    {
        ...
        return redirect()->route('admin.gambar')->with('update', 'File Berhasil Diupdate!');
    }
    ...
    public function destroy($id_gambar_des)
    {
        ...
        return redirect()->route('admin.gambar')->with('error', 'File Berhasil Dihapus!');
    }
}
